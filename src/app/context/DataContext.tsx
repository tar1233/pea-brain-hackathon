        ...
        json.eBiddingData = {
          ...
          simulation: {
            ...
            steps: [
              {
                id: 1,
                title: "Step 1: วิเคราะห์และคำนวณเป้าหมายจัดซื้อ",
                detail: "AI ดึงข้อมูลจาก WMS พบยอดคงคลัง (Current Stock) = 200 เครื่อง และวิเคราะห์ประวัติการเบิกจ่ายจาก SAP พยากรณ์ความต้องการ (Demand) ล่วงหน้า 6 เดือนอยู่ที่ 1,000 เครื่อง",
                aiAction: "คำนวณ Net Requirement: (Demand 1,000 - Stock 200) = 800 เครื่อง AI แนะนำให้ตั้งเป้าจัดซื้อ 800 เครื่อง เพื่อรักษาระดับ Safety Stock และเปิดประมูล 100% ตามจังหวะราคาตลาดที่เหมาะสม",
                status: "completed"
              },
              {
                id: 2,
