    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="bg-gradient-to-br from-[#2e0854] via-[#5c0670] to-[#b33617] rounded-3xl p-6 lg:p-8 text-white relative overflow-hidden flex flex-col lg:flex-row items-center justify-between shadow-[0_20px_50px_rgba(46,16,138,0.15)] border border-purple-500/10">
        ...
        <div className="relative z-10 flex flex-col gap-4 max-w-xl">
          <div className="flex items-center gap-3">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-3.5 py-1.5 rounded-full text-[13px] font-bold tracking-widest w-max border border-white/20 uppercase">
            ...
            <select 
              ...
              className="bg-white/20 border border-white/30 text-white text-[13px] font-bold px-3 py-1.5 rounded-full outline-none cursor-pointer appearance-none"
            >
          ...
          <p className="text-white/80 text-[14px] leading-relaxed max-w-md mt-1 font-medium">
        ...
        <div className="relative z-10 flex gap-4 mt-6 lg:mt-0 w-full lg:w-auto">
          ...
          <div className="bg-white/15 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex flex-col gap-1 min-w-[210px] shadow-[0_12px_24px_rgba(0,0,0,0.05)]">
            <div className="text-white/70 text-[13px] font-bold uppercase tracking-wider mb-1">มูลค่าความเสี่ยงรวม</div>
            ...
            <div className="text-white/60 text-[13px] mt-1 font-medium">จากความเสี่ยง shortage<br/>และ overstock</div>
          ...
          {/* Card 2 */}
          <div className="bg-white/15 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex flex-col gap-1 min-w-[210px] shadow-[0_12px_24px_rgba(0,0,0,0.05)]">
            <div className="text-white/70 text-[13px] font-bold uppercase tracking-wider mb-1">ช่องว่าง SAFETY STOCK</div>
            ...
            <div className="text-white/60 text-[13px] mt-1 font-medium">คิดเป็นมูลค่าประมาณ<br/>฿36.5 ล้าน</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-[#4e091b] via-[#750e26] to-[#b91c1c] rounded-3xl p-5 border border-rose-500/20 shadow-[0_15px_35px_rgba(185,28,28,0.1)] flex flex-col relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(185,28,28,0.18)]">
          ...
          <div className="text-[13px] text-white/70 mb-4 font-medium">ต้องตัดสินใจก่อนส่งผลกระทบ</div>
          <div onClick={() => document.getElementById('wh-priority')?.scrollIntoView({ behavior: 'smooth' })} className="mt-auto flex items-center text-[13px] font-bold text-white bg-white/15 hover:bg-white/25 px-3 py-1.5 rounded-lg w-max cursor-pointer transition-all border border-white/10">
        ...
        <div className="bg-gradient-to-br from-emerald-50/70 to-teal-50/40 rounded-3xl p-5 border border-emerald-100/60 shadow-[0_12px_24px_rgba(0,0,0,0.015)] flex flex-col relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(16,185,129,0.05)]">
          ...
          <div className="text-[13px] text-slate-500 mb-4 font-medium">เฉลี่ยเทียบกับ safety stock</div>
          <div className="mt-auto flex items-center text-[13px] font-bold text-emerald-800 bg-emerald-50/80 border border-emerald-100/60 px-3 py-1.5 rounded-lg w-max">
        ...
        <div className="bg-gradient-to-br from-blue-50/70 to-indigo-50/40 rounded-3xl p-5 border border-blue-100/60 shadow-[0_12px_24px_rgba(0,0,0,0.015)] flex flex-col relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(59,130,246,0.05)]">
          ...
          <div className="text-[13px] text-slate-500 mb-4 font-medium">มูลค่ารวม ฿82.2 ล้าน</div>
          <div onClick={() => document.getElementById('wh-rebalancing')?.scrollIntoView({ behavior: 'smooth' })} className="mt-auto flex items-center text-[13px] font-bold text-blue-800 bg-blue-50/80 hover:bg-blue-100/80 border border-blue-100/60 px-3 py-1.5 rounded-lg w-max cursor-pointer transition-all">
        ...
        <div className="bg-gradient-to-br from-orange-50/70 to-amber-50/40 rounded-3xl p-5 border border-orange-100/60 shadow-[0_12px_24px_rgba(0,0,0,0.015)] flex flex-col relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(245,158,11,0.05)]">
          ...
          <div className="text-[13px] text-slate-500 mb-4 font-medium">ความเสี่ยงปานกลางถึงสูง</div>
          <div onClick={() => document.getElementById('wh-overview')?.scrollIntoView({ behavior: 'smooth' })} className="mt-auto flex items-center text-[13px] font-bold text-orange-800 bg-orange-50/80 hover:bg-orange-100/80 border border-orange-100/60 px-3 py-1.5 rounded-lg w-max cursor-pointer transition-all">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.3fr] gap-8 mt-2">
        ...
        <div id="wh-priority" className="flex flex-col gap-5">
          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 border-l-4 border-l-red-500">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="bg-red-50 text-red-500 text-[13px] px-2.5 py-1 rounded-md font-bold uppercase tracking-wider">ขาดแคลน</span>
                  </div>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              <div className="flex flex-col gap-1.5">
                <span className="text-[13px] text-gray-400 font-medium flex items-center gap-1.5"><AlertTriangle className="w-3.5 h-3.5" /> มูลค่าความเสี่ยง</span>
                <span className="text-[13px] font-extrabold text-gray-800">฿13.8 ล้าน</span>
              </div>
              <div className="flex flex-col gap-1.5">
                <span className="text-[13px] text-gray-400 font-medium flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5" /> พื้นที่</span>
                <span className="text-[13px] font-extrabold text-gray-800">คลังอยุธยา</span>
              </div>
              <div className="flex flex-col gap-1.5">
                <span className="text-[13px] text-gray-400 font-medium flex items-center gap-1.5"><RotateCw className="w-3.5 h-3.5" /> Lead time</span>
                <span className="text-[13px] font-extrabold text-gray-800">12 สัปดาห์</span>
              </div>
              <div className="flex flex-col gap-1.5">
                <span className="text-[13px] text-gray-400 font-medium flex items-center gap-1.5"><BarChart3 className="w-3.5 h-3.5" /> Confidence</span>
            ...
            <div className="bg-[#FFF9F2] rounded-2xl p-5 flex justify-between items-center">
              <div>
                <div className="text-[13px] font-bold text-orange-500 uppercase tracking-wider mb-1.5">คำแนะนำ AI Copilot</div>
          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 border-l-4 border-l-amber-500">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="bg-orange-50 text-orange-500 text-[13px] px-2.5 py-1 rounded-md font-bold uppercase tracking-wider">เสี่ยงเกิน</span>
                  </div>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              <div className="flex flex-col gap-1.5">
                <span className="text-[13px] text-gray-400 font-medium flex items-center gap-1.5"><AlertTriangle className="w-3.5 h-3.5" /> มูลค่าส่วนเกิน</span>
          ...
          <div id="wh-overview" className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="text-[13px] uppercase tracking-wider text-gray-400 border-b border-gray-100/50">
                ...
                <tbody className="divide-y divide-gray-50">
                  <tr className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="py-4 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        <span className="bg-red-50 text-red-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">12</span>
                        <span className="bg-orange-50 text-orange-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">3</span>
                      </div>
                    </td>
                    <td className="py-4 text-right font-bold text-gray-700 text-xs">฿198.6 ล้าน</td>
                    <td className="py-4 text-center"><span className="text-[13px] font-bold text-[#A80689] bg-purple-50 px-2.5 py-1 rounded-md">จัดหาเพิ่ม</span></td>
                  </tr>
                  ...
                  <tr className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="py-4 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        <span className="bg-red-50 text-red-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">5</span>
                        <span className="bg-orange-50 text-orange-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">2</span>
                      </div>
                    </td>
                    <td className="py-4 text-right font-bold text-gray-700 text-xs">฿82.2 ล้าน</td>
                    <td className="py-4 text-center"><span className="text-[13px] font-bold text-[#A80689] bg-fuchsia-50 px-2.5 py-1 rounded-md">โอนย้ายออก</span></td>
                  </tr>
                  ...
                  <tr className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="py-4 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        <span className="bg-emerald-50 text-emerald-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">1</span>
                        <span className="bg-orange-50 text-orange-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">4</span>
                      </div>
                    </td>
                    <td className="py-4 text-right font-bold text-gray-700 text-xs">฿24.5 ล้าน</td>
                    <td className="py-4 text-center"><span className="text-[13px] font-bold text-[#A80689] bg-fuchsia-50 px-2.5 py-1 rounded-md">รับโอนย้าย</span></td>
                  </tr>
                  ...
                  <tr className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="py-4 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        <span className="bg-red-50 text-red-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">2</span>
                        <span className="bg-orange-50 text-orange-600 text-[13px] font-bold px-1.5 py-0.5 rounded-md w-5 text-center">1</span>
                      </div>
                    </td>
                    <td className="py-4 text-right font-bold text-gray-700 text-xs">฿15.7 ล้าน</td>
                    <td className="py-4 text-center"><span className="text-[13px] font-bold text-gray-500 bg-gray-50 px-2.5 py-1 rounded-md">คงสต๊อก</span></td>
                  </tr>
                  ...
                  <tr className="hover:bg-gray-50/50 transition">
                    ...
                    <td className="py-4 text-center"><span className="text-[13px] font-bold text-blue-600 bg-blue-50 px-2.5 py-1 rounded-md">ปรับสมดุล</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
            
            <div className="flex items-center gap-4 mt-4 text-[13px] font-medium text-gray-500 border-t border-gray-100/50 pt-5">
          ...
          <div id="wh-rebalancing" className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 mt-1 relative overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <div className="flex flex-col gap-4 relative z-10">
              ...
              <div className="bg-[#FCFBFF] rounded-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-6 hover:bg-purple-50/30 transition-colors duration-300">
                <div className="flex items-center gap-6 flex-1 w-full justify-between">
                  <div className="flex flex-col flex-1">
                    <span className="text-[13px] text-gray-400 font-bold uppercase tracking-wider mb-1">จาก คลังชลบุรี</span>
                    <span className="text-sm font-extrabold text-[#A80689]">โอนย้าย 80 เครื่อง</span>
                    <span className="text-[13px] font-bold text-gray-700 bg-white shadow-sm px-2 py-1 rounded-md mt-1.5 w-max">CT-400/5A</span>
                  </div>
                  ...
                  <div className="flex flex-col flex-1 text-right">
                    <span className="text-[13px] text-gray-400 font-bold uppercase tracking-wider mb-1">ไป คลังเชียงใหม่</span>
                ...
                <div className="flex flex-col items-center md:items-end w-full md:w-auto">
                  <span className="text-[13px] text-gray-500 font-medium mb-2">คาดว่าจะลดผลกระทบได้ <span className="font-extrabold text-gray-800 text-[13px]">฿2.8 ล้าน</span></span>
              ...
              <div className="bg-purple-50/40 rounded-xl p-4 border border-purple-100/50 flex flex-col md:flex-row items-center justify-between gap-6 hover:shadow-sm transition">
                <div className="flex items-center gap-6 flex-1 w-full justify-between">
                  <div className="flex flex-col flex-1">
                    <span className="text-[13px] text-gray-500 font-medium mb-0.5">จาก คลังชลบุรี</span>
                    <span className="text-sm font-extrabold text-[#A80689]">โอนย้าย 50 เครื่อง</span>
                    <span className="text-[13px] font-bold text-gray-600 bg-white border border-gray-200 px-1.5 py-0.5 rounded mt-1.5 w-max">LA-22kV</span>
                  </div>
                  <div className="flex flex-col items-center justify-center px-4">
                  ...
                  <div className="flex flex-col flex-1 text-right">
                    <span className="text-[13px] text-gray-500 font-medium mb-0.5">ไป คลังอยุธยา</span>
                ...
                <div className="flex flex-col items-center md:items-end w-full md:w-auto">
                  <span className="text-[13px] text-gray-500 font-medium mb-1.5">คาดว่าจะลดผลกระทบได้ <span className="font-bold text-gray-700">฿3.1 ล้าน</span></span>
