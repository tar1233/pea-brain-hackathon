      ...
      <main className="max-w-[1400px] mx-auto px-8 py-6 space-y-6">
        ...
        {aiResult && !isAnalyzing && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {/* Financial & Procurement Summary Table (Excel Style) */}
            {(() => {
            ...
            {readonly && approvedPlan && (
              <div className="bg-white rounded-xl shadow-sm border border-emerald-200 overflow-hidden mt-6">
                <div className="flex justify-between items-center p-4 border-b border-emerald-200 bg-emerald-50">
                  <div>
                    <h3 className="text-[14px] md:text-[16px] font-bold text-emerald-900 flex items-center gap-2">
                      <CheckCircle2 size={18} className="text-emerald-600" />
                      แผนที่ AI แนะนำ (อนุมัติแล้ว)
                    </h3>
                    <p className="text-[11px] md:text-[12px] text-emerald-700 mt-1">สรุปแผนจัดซื้อที่ผ่านการอนุมัติเรียบร้อยแล้ว</p>
                  </div>
                  <span className="shrink-0 bg-emerald-600 text-white px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider">
                    Approved ✓
                  </span>
                </div>
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse min-w-[600px]">
                    <tbody className="divide-y divide-slate-100">
                      <tr className="hover:bg-slate-50/50">
                        <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">📋 ชื่อแผน</td>
                        <td className="px-4 py-3 text-[14px] font-bold text-emerald-800">{approvedPlan.planName || 'แผนจัดซื้ออนุมัติ'}</td>
                      </tr>
                      <tr className="hover:bg-slate-50/50">
                        <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">🎯 การดำเนินการ</td>
                        <td className="px-4 py-3 text-[13px] text-slate-700 leading-relaxed">{approvedPlan.action || 'จัดซื้อตามแผนที่อนุมัติ'}</td>
                      </tr>
                      <tr className="hover:bg-slate-50/50">
                        <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">📦 จำนวนสั่งซื้อ</td>
                      ...
                      {approvedPlan.financial && (
                        <tr className="hover:bg-slate-50/50">
                          <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">💰 วิเคราะห์การเงิน</td>
                          <td className="px-4 py-3 text-[13px] text-slate-700 leading-relaxed">{approvedPlan.financial}</td>
                        </tr>
                      )}
                      {approvedPlan.supplyForecast && (
                        <tr className="hover:bg-slate-50/50">
                          <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">📦 การพยากรณ์ Supply</td>
                          <td className="px-4 py-3 text-[13px] text-slate-700 leading-relaxed">{approvedPlan.supplyForecast}</td>
                        </tr>
                      )}
                      {approvedPlan.risk && (
                        <tr className="hover:bg-amber-50/30">
                          <td className="px-4 py-3 font-bold text-amber-700 w-[25%] bg-amber-50/50 text-[13px]">⚠️ ความเสี่ยง</td>
                          <td className="px-4 py-3 text-[13px] text-amber-800 leading-relaxed">{approvedPlan.risk}</td>
                        </tr>
                      )}
                      {approvedPlan.mitigation && (
                        <tr className="hover:bg-slate-50/50">
                          <td className="px-4 py-3 font-bold text-slate-700 w-[25%] bg-slate-50/50 text-[13px]">🛡️ แผนรับมือ</td>
                          <td className="px-4 py-3 text-[13px] text-slate-700 leading-relaxed">{approvedPlan.mitigation}</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
