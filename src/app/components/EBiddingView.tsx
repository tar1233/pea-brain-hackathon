...
ตอบ JSON ตามนี้ (ห้ามมี markdown ห้ามมี text อื่น):
{
  ...
  "planA": {
    "title": "ชื่อแผนสั้นๆ",
    "qty": ตัวเลข,
    "futureImpact": "[ตอบ ห้ามซ้ำกับ supplyForecast] ผลกระทบเชิงกลยุทธ์: สั่ง X ชิ้นจะครอบคลุมความต้องการทั้งปี ${mat?.annualDemand} ชิ้นได้ X% ถ้าไม่สั่งจะเกิดผลกระทบต่อระบบจำหน่ายไฟฟ้าเพราะ... หน่วยงานที่ได้รับผลกระทบคือ... ความเสียหายประมาณ ฿X เพราะ...",
    "supplyForecast": "[ตอบ ห้ามซ้ำกับ futureImpact] แผนการสั่งซื้อ: ต้องสั่งทั้งหมด X รอบ รอบแรกเดือน X จำนวน X ชิ้น รอบถัดไปเดือน X จำนวน X ชิ้น ปัญหาขาดแคลนจะจบในเดือน X เพราะ...",
  ...
  "planB": {
    "title": "ชื่อแผนสำรอง",
    "qty": ตัวเลข,
    "futureImpact": "[ตอบ ห้ามซ้ำกับ supplyForecast] ผลกระทบเชิงกลยุทธ์: ครอบคลุมความต้องการ X% ถ้าไม่ทำจะเกิดผลกระทบ... เพราะ...",
    "supplyForecast": "[ตอบ ห้ามซ้ำกับ futureImpact] แผนการสั่งซื้อ: ต้องสั่งทั้งหมด X รอบ เดือน X, X ปัญหาจะจบเดือน X เพราะ...",
