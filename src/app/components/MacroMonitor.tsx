    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm relative overflow-hidden group">
        ...
        <div className="flex justify-between items-start mb-2">
          <div className="flex items-center gap-2 text-[16.5px] font-bold text-slate-500 uppercase">
            <DollarSign size={16} className="text-blue-500" />
            USD/THB (Real-time FX)
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[16.5px] text-slate-400 font-medium bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100">API: BOT Open Data</span>
        ...
        <div className="flex items-end gap-3">
          ...
          <div className={`flex items-center gap-1 text-[16.5px] font-bold px-2 py-0.5 rounded-full mb-1.5 ${
        ...
        <div className="mt-2 pt-2 border-t border-slate-100">
          <p className="text-[16.5px] text-slate-500 font-medium leading-tight">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm relative overflow-hidden group">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[16.5px] text-slate-400 font-medium bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100">API: LME Direct</span>
            {isUpdating && <RefreshCw size={12} className="text-slate-400 animate-spin" />}
          </div>
        </div>
        <div className="flex items-end gap-3">
        ...
        <p className="text-[16.5px] text-slate-400 mt-2 font-medium flex items-center gap-1"><Zap size={10} className="text-emerald-500"/> AI Agent มอนิเตอร์เพื่อรอจังหวะซื้อเข้า</p>
        <div className="mt-2 pt-2 border-t border-slate-100">
          <p className="text-[16.5px] text-slate-500 font-medium leading-tight">
      ...
      <div className="bg-indigo-900 rounded-2xl p-5 border border-indigo-700 shadow-sm relative overflow-hidden group text-white">
        ...
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center gap-2 text-[16.5px] font-bold text-indigo-200 uppercase">
            <Newspaper size={16} className="text-fuchsia-400" />
            Macro-economic Alerts
          </div>
          <span className="text-[16.5px] text-indigo-300 font-medium bg-indigo-800/50 px-1.5 py-0.5 rounded border border-indigo-500/30">Source: GDELT Project</span>
        </div>
        
        <div className="space-y-3">
          <div className="bg-indigo-800/50 backdrop-blur-sm rounded-xl p-3 border border-indigo-500/30">
            <div className="flex justify-between items-start">
              <span className="bg-rose-500 text-white text-[16.5px] font-bold px-2 py-0.5 rounded-full uppercase mb-1 inline-block">Trade War Alert</span>
              <span className="text-[16.5px] text-indigo-300">2 mins ago</span>
            </div>
            <p className="text-[16.5px] font-medium leading-tight">สหรัฐฯ เล็งขึ้นภาษีนำเข้าโซลาร์เซลล์จีน 30% ส่งผลกระทบ Supply Chain ทั่วโลก</p>
          </div>
          
          <div className="flex items-center gap-2 text-[16.5px] text-emerald-300 font-bold bg-indigo-950/50 p-2 rounded-lg border border-emerald-500/20">
            <Zap size={14} /> AI Action: เสนอสั่งซื้อแผงโซลาร์ล่วงหน้า 3 เดือนทันที
          </div>
          
          <div className="mt-1 pt-2 border-t border-indigo-500/30">
            <p className="text-[16.5px] text-indigo-200 font-medium leading-tight">
